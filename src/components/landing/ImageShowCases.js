        ...
        <section className="showcase">
            <div className="container-fluid p-0">
                ...
                <div className="row no-gutters">
                    <div className="col-lg-6 order-lg-2 text-white showcase-img showcase-bg-1"/>
                ...
                <div className="row no-gutters">
                    <div className="col-lg-6 text-white showcase-img showcase-bg-2"/>
                ...
                <div className="row no-gutters">
                    <div className="col-lg-6 order-lg-2 text-white showcase-img showcase-bg-3"/>
                    <div className="col-lg-6 order-lg-1 my-auto showcase-text">
